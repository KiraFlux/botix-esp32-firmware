...
[[nodiscard]] constexpr auto integer(kf::StringView lexeme) noexcept -> kf::Option<kf::i64> {
    if (lexeme.empty()) {
        return kf::none;
    }
...
[[nodiscard]] constexpr auto real(kf::StringView lexeme) noexcept -> kf::Option<kf::f32> {
    if (lexeme.empty()) {
        return kf::none;
    }
...
[[nodiscard]] constexpr auto ipv4(kf::StringView lexeme) noexcept -> kf::Option<kf::u32> {
    kf::u32 address = 0;
    kf::usize i = 0;
